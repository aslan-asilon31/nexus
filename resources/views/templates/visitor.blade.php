...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('assets_front/assets/css/fontawesome.css') }}">
    <link rel="stylesheet" href="{{ asset('assets_front/assets/css/templatemo-finance-business.css') }}">
    <link rel="stylesheet" href="{{ asset('assets_front/assets/css/owl.css') }}">
<!--
...
-->
  ...
  <body>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="service-item">
              <img src="assets_front/assets/images/service_01.jpg" alt="">
          ...
          <div class="col-md-4">
            <div class="service-item">
              <img src="assets_front/assets/images/service_02.jpg" alt="">
              <div class="down-content">
          ...
          <div class="col-md-4">
            <div class="service-item">
              <img src="assets_front/assets/images/service_03.jpg" alt="">
              <div class="down-content">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="left-image">
                    <img src="assets_front/assets/images/more-info.jpg" alt="">
                  </div>
                </div>
                <div class="col-md-6 align-self-center">
          ...
          <div class="col-md-12">
            <div class="owl-testimonials owl-carousel">
              ...
              <div class="testimonial-item">
                ...
                <img src="assets_front/http://placehold.it/60x60" alt="">
              </div>
          ...
          <div class="col-md-12">
            <div class="owl-partners owl-carousel">
              ...
              <div class="partner-item">
                <img src="assets_front/assets/images/client-01.png" title="1" alt="1">
              </div>
              
              <div class="partner-item">
                <img src="assets_front/assets/images/client-01.png" title="2" alt="2">
              </div>
              
              <div class="partner-item">
                <img src="assets_front/assets/images/client-01.png" title="3" alt="3">
              </div>
              
              <div class="partner-item">
                <img src="assets_front/assets/images/client-01.png" title="4" alt="4">
              </div>
              
              <div class="partner-item">
                <img src="assets_front/assets/images/client-01.png" title="5" alt="5">
              </div>
    ...
    <script src="{{ asset('assets_front/vendor/jquery/jquery.min.js') }}"></script>
    ...
    <script src="{{ asset('assets_front/assets/js/owl.js') }}"></script>
    <script src="{{ asset('assets_front/assets/js/slick.js') }}"></script>
    <script src="{{ asset('assets_front/assets/js/accordions.js') }}"></script>
